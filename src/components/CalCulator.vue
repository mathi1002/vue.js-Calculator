<template>
  <!--heading-->
  <div class="p-4" style="max-width:400px;margin:25px auto;background:#123">
<!--cal reslt-->
<div class="bg-vue-dark lead w-full rounded m-1 p-3 text-right font-weight-bold text-white">
  {{calculatorValue || 0}}
</div>
<!--cal button-->
<div class="row ">
